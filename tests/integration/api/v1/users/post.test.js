  ...
  describe("Anonymous user", () => {
    test("With unique and valid data", async () => {
      const response = await fetch("http://localhost:3000/api/v1/users", {
        ...
        // Pega objeto javascript e converte para uma string em json.
        body: JSON.stringify({
          username: "alexdesouza",
          email: "alex94tu@gmail.com",
          password: "senha123",
        }),
      });
      ...
      const userInDatabase = await user.findOneByUsername("alexdesouza");
      //Compare senha enviada no post com senha recuperada do banco de dados.
